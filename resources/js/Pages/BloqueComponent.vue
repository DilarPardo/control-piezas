...
function saveBloque() {
    if (isEdit.value) {
        router.put(`/bloques/${form.id_bloque}`, {
            ...
            onError: () => {
                alert('Ocurrió un error al actualizar el bloque.')
            }
        })
    } else {
        router.post('/bloques', {
            ...
            onError: () => {
                alert('Ocurrió un error al crear el bloque.')
            }
        })
    }
}
            ...
            <div class="bg-white rounded shadow p-6 w-full max-w-md">
                ...
                <form @submit.prevent="saveBloque">
                    <div class="mb-4">
                        ...
                        <input v-model="form.nombre_bloque" type="text"
                            class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" maxlength="10" />
                    </div>
                    <div class="mb-4">
